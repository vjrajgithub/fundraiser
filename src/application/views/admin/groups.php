          ...
          <div class="dashboard-pages">
            <div class="pages-top">
              <ul class="list-inline">
                ...
                <li class="active"><a href="<?php echo site_url('admin/groups')?>"><i class="fa fa-gears"></i> Groups</a></li>
              </ul>
            </div>
                ...
                <div class="col-md-12">
                  <div class="page-contentLt">
                    <div class="top-title">
                      ...
                      <a href="#" class="btn btn-success btn-sm pull-right">Create Group</a> </div>
                        ...
                        <ul class="list-inline">
                          ...
                          <li class="dropdown"> <a class=" dropdown-toggle btn btn-primary btn-sm" data-toggle="dropdown"> All <i class="fa fa-angle-down"></i> </a>
                            <ul class="dropdown-menu">
                              <li><a href="#">Campaigners</a></li>
                              <li><a href="#">ECOntributors</a></li>
                    ...
                    <div class="row">
                      <div class="col-sm-9">
                        <div class="result-image">
                          <div class="result-imgLt"> <img src="/assets/temp/images/g.jpg" width="55" height="55"> </div>
                          <div class="result-imgRt">
                            <h5><a href="#">test</a></h5>
                            <a href="#"><i class="fa fa-envelope"></i> mail@gmail.com</a> </div>
                        </div>
                      </div>
                      <div class="col-sm-3">
