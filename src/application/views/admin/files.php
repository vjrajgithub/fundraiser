          ...
          <div class="dashboard-pages">
            <div class="pages-top">
              <ul class="list-inline">
                ...
                <li class="active"><a href="<?php echo site_url('admin/files')?>"><i class="fa fa-folder"></i> Files</a></li>
              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="page-contentLt">
                    ...
                    <h5 class="uppercase"><strong>Files</strong> <i class="fa fa-question-circle green"></i></h5>
                    
                    
                    <div class="drag-dropBox">
                    ...
                    <p><strong>What are files?</strong></p>
                    <p>Upload files to our high speed server to use for your pages, HTML and CSS.</p>
                    <p>Get Started by clicking the file chooser to select a file.</p>
                  </div>
                </div>
              </div>
            </div>
