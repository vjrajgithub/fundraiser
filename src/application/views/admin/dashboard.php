          ...
          <div class="dashboard-pages">
            <div class="pages-top">
              <ul class="list-inline">
                <li class="active"><a href="<?php echo site_url('admin/dashboard')?>"><i class="fa fa-tachometer"></i> Dashboard</a></li>
              ...
              <div class="row">
                <div class="col-md-8">
                  <div class="page-contentLt">
                    <p><strong>Logo</strong> <i class="fa fa-question-circle green"></i></p>
                    <div class="logo-section">
                      <div class="logo-sectionInn"> <img src="/assets/temp/images/logo2.png" class="img-responsive"> </div>
                      <div class="logo-name"> 253465_boonlogo.png </div>
                      <div class="drag-file">
                        <div class="link-icon"> <a href="#"> <i class="fa fa-link"></i></a> </div>
                        <div class="drag-msg"> Drag and Drop file, Or <a href="#">Click Here...</a> </div>
                      </div>
                    </div>
                    <div class="dashboard-bottm">
                      <div class="export">
                        <ul class="list-inline">
                          <li><a href="#" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#myModal"><i class="fa fa-upload"></i> Export</a></li>
                        </ul>
                      </div>
                      <div class="delete"> <a href="#" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i> Delete</a> </div>
                    </div>
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="page-contentLt">
                    <ul>
                      <li>Registered users <span>1</span></li>
                      <li>Active campaigns <span>0</span></li>
                      <li>Confirmed Contributions <span>0</span></li>
                      <li>Total contributed <span>OTHB</span></li>
                    </ul>
                  </div>
                </div>
              </div>
