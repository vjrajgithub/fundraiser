                  ...
                  <div class="page-contentLt">
                    <div class="cong-options">
                      <ul class="list-inline">
                        ...
                        <li><a href="<?php echo site_url('admin/configuration/sharing')?>" class="btn btn-primary btn-sm">Sharing</a></li>
                        ...
                        <div class="col-md-5">
                          <form>
                            <div class="form-group">
                              <label for="exampleInputEmail1">Campaign Share Button <i class="fa fa-question-circle green"></i></label>
                              <div class="clearfix"></div>
                              <label class="checkbox-inline">
                                <input type="checkbox" name="inlineRadioOptions" id="inlineRadio2" value="option2" checked>
                                Facebook </label>
                              <label class="checkbox-inline">
                                <input type="checkbox" name="inlineRadioOptions" id="inlineRadio3" value="option3" checked>
                                Twitter </label>
                              <label class="checkbox-inline">
                                <input type="checkbox" name="inlineRadioOptions" id="inlineRadio3" value="option3" checked>
                                Pinterest </label>
                            ...
                            <div class="form-group"> <span class="gray-sm-text">Twitter user name</span>
                              <input type="email" class="form-control" id="exampleInputPassword1" placeholder="@ Enter twitter user name">
                            </div>
                            <div class="form-group">
                              <label for="exampleInputPassword1">Site &amp; RSS Feed <i class="fa fa-question-circle green"></i></label>
                              <div class="clearfix mr_b10"></div>
                              <a href="#" class="btn btn-success btn-xs mr_b10">Update Site Map</a>
                              <p><i class="fa fa-rss green"></i> Your RSS Feed is available at:</p>
                              <a href="#">http://test.com</a> </div>
                            <hr>
                            <div class="form-group mr_b40">
                              <label for="exampleInputPassword1">Google Analytics <i class="fa fa-question-circle green"></i></label>
                              <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Enter Google Tracking ID">
                            </div>
                            <div class="form-group mr_none">
                              <label for="exampleInputPassword1">Google login <i class="fa fa-question-circle green"></i></label>
                            </div>
                            <div class="form-group">
                              <label class="checkbox-inline">
                                <input type="checkbox" checked="" value="option3" id="inlineRadio3" name="inlineRadioOptions">
                                Enabled </label>
                            </div>
                            <div class="form-group">
                              <label for="exampleInputPassword1">Google client ID <i class="fa fa-question-circle green"></i></label>
                              <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Enter google client ID">
                            </div>
                            <hr>
                            <div class="form-group">
                              <label for="exampleInputEmail1">Facebook login <i class="fa fa-question-circle green"></i></label>
                              <div class="clearfix"></div>
                              <label class="checkbox-inline">
                                <input type="checkbox" checked="" value="option2" id="inlineRadio2" name="inlineRadioOptions">
                                Enabled </label>
                            </div>
                            <div class="form-group">
                              <label for="exampleInputPassword1">Facebook App ID <i class="fa fa-question-circle green"></i></label>
                              <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Enter facebook app id">
                            </div>
                            <div class="form-group">
                              <label for="exampleInputPassword1">Facebook Secrer <i class="fa fa-question-circle green"></i></label>
                              <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Enter facebook secret">
                            </div>
                          </form>
                        </div>
                      </div>
