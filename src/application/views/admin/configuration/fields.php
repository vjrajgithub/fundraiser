                  ...
                  <div class="page-contentLt">
                    <div class="cong-options">
                      <ul class="list-inline">
                        ...
                        <li><a href="<?php echo site_url('admin/configuration/fields')?>" class="btn btn-primary btn-sm">Fields</a></li>
                    ...
                    <div class="configuration-form">
                      <div class="row">
                        <div class="col-md-12">
                          <form>
                            <div class="display-campign"> <span class="pull-left ft12">Add additional fields to your forms <i class="fa fa-question-circle green"></i></span> </div>
                            <div class="fields-list">
                              <ul>
                                <li>User form field <a href="#" class="btn btn-primary btn-xs">ADD</a></li>
                                <li>Compaign form field <a href="#" class="btn btn-primary btn-xs">ADD</a></li>
                                <li>Contribution form field <a href="#" class="btn btn-primary btn-xs">ADD</a></li>
                              </ul>
                            </div>
                          </form>
                        </div>
