                  ...
                  <div class="page-contentLt">
                    <div class="cong-options">
                      <ul class="list-inline">
                        ...
                        <li><a href="<?php echo site_url('admin/configuration/appearance')?>" class="btn btn-primary btn-sm">Appearance</a></li>
                        ...
                        <div class="col-md-6">
                          <form>
                            <div class="form-group mr_b30">
                              <label for="exampleInputPassword1">Compaign Tabs Position <i class="fa fa-question-circle green"></i></label>
                              <div class="clearfix"></div>
                              <label class="radio-inline">
                                <input type="radio" name="inlineRadioOptions" id="inlineRadio1" value="option1" checked>
                                Below video/image </label>
                              <label class="radio-inline">
                                <input type="radio" name="inlineRadioOptions" id="inlineRadio2" value="option2">
                                Above video/image </label>
                            </div>
                            <div class="form-group mr_b40">
                              <label for="exampleInputPassword1">Default User Images <i class="fa fa-question-circle green"></i></label>
                              <div class="clearfix"></div>
                              <label class="radio-inline">
                                <input type="radio" name="inlineRadioOptions" id="inlineRadio1" value="option1">
                                <i class="fa fa-user dark-user"></i></label>
                              <label class="radio-inline">
                                <input type="radio" name="inlineRadioOptions" id="inlineRadio1" value="option1">
                                <i class="fa fa-user medium-user"></i></label>
                              <label class="radio-inline">
                                <input type="radio" name="inlineRadioOptions" id="inlineRadio1" value="option1">
                                <i class="fa fa-user fade-user"></i></label>
                            </div>
                          </form>
                        </div>
                      </div>
