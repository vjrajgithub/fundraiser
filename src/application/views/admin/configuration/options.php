                  ...
                  <div class="page-contentLt">
                    <div class="cong-options">
                      <ul class="list-inline">
                        ...
                        <li><a href="<?php echo site_url('admin/configuration/options')?>" class="btn btn-primary btn-sm">Options</a></li>
                        ...
                        <div class="col-md-6">
                          <form>
                            <div class="form-group">
                              <label for="exampleInputEmail1">View Options <i class="fa fa-question-circle green"></i></label>
                              <div class="row">
                                <div class="col-sm-6">
                                  <div class="checkbox mr_b25">
                                    <label>
                                      <input type="checkbox" value="">
                                      Log in to contribute </label>
                                  </div>
                                  <div class="checkbox mr_b25">
                                    <label>
                                      <input type="checkbox" value="">
                                  ...
                                  <div class="checkbox mr_b25">
                                    <label>
                                      <input type="checkbox" value="">
                                      Compaign login required </label>
                                  </div>
                                  <div class="checkbox mr_b25">
                                    <label>
                                      <input type="checkbox" value="">
                                      Compaign always editable </label>
                                  </div>
                                </div>
                                <div class="col-sm-6">
                                  <div class="checkbox mr_b25">
                            ...
                            <div class="form-group mr_b40">
                              <label for="exampleInputPassword1">Group Options <i class="fa fa-question-circle green"></i></label>
                            ...
                            <div class="form-group">
                              <label for="exampleInputPassword1">Compaign Type <i class="fa fa-question-circle green"></i></label>
                              <div class="clearfix"></div>
                              <label class="radio-inline">
                                <input type="radio" name="inlineRadioOptions" id="inlineRadio1" value="option1">
                                All or nothing </label>
                              <label class="radio-inline">
                                <input type="radio" name="inlineRadioOptions" id="inlineRadio2" value="option2">
                                Keep it all </label>
                              <label class="radio-inline">
                                <input type="radio" name="inlineRadioOptions" id="inlineRadio3" value="option3" checked>
                                Optional </label>
                            </div>
                            <div class="form-group mr_b40">
                              <label for="exampleInputPassword1">Compaign Duration <i class="fa fa-question-circle green"></i></label>
                              <div class="clearfix"></div>
                              <label class="radio-inline">
                                <input type="radio" name="inlineRadioOptions" id="inlineRadio1" value="option1">
                                Limited </label>
                            ...
                            <div class="form-group">
                              <label for="exampleInputPassword1">Compaign Video Type <i class="fa fa-question-circle green"></i></label>
                              <div class="clearfix"></div>
                              <label class="checkbox-inline">
                                <input type="checkbox" id="inlineCheckbox1" value="option1">
                                Vimeo </label>
                            ...
                            <div class="form-group mr_b50">
                              <label for="exampleInputPassword1">Compaign Default Image <i class="fa fa-question-circle green"></i></label>
                              <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Enter image URL">
                            </div>
                            <div class="form-group">
                              <label for="exampleInputPassword1">Compaign Rewards <i class="fa fa-question-circle green"></i></label>
                              <div class="clearfix"></div>
                              <label class="checkbox-inline">
                            ...
                            <div class="form-group">
                              <label for="exampleInputPassword1">Rewards Image <i class="fa fa-question-circle green"></i></label>
                              <div class="clearfix"></div>
                              <label class="checkbox-inline">
                                <input type="checkbox" id="inlineCheckbox1" value="option1" checked>
                                Enable </label>
                            ...
                            <div class="form-group mr_b50">
                              <label for="exampleInputPassword1">Max Rewards <i class="fa fa-question-circle green"></i></label>
                              <input type="text" placeholder="20" id="20" class="form-control">
                            </div>
                            <div class="form-group">
                              <label for="exampleInputPassword1">Compaign Commitments <i class="fa fa-question-circle green"></i></label>
                              <div class="clearfix"></div>
                              <label class="checkbox-inline">
                                <input type="checkbox" id="inlineCheckbox1" value="option1" checked>
                                Enable </label>
                            ...
                            <div class="form-group">
                              <label for="exampleInputPassword1">Commitments Image <i class="fa fa-question-circle green"></i></label>
                              <div class="clearfix"></div>
                              <label class="checkbox-inline">
                                <input type="checkbox" id="inlineCheckbox1" value="option1">
                                Enable </label>
